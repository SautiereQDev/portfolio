...
import { ChevronLeft, ChevronRight, Home, User, Briefcase, FolderOpen, Mail } from "lucide-react"
...
export const PageNavigation = ({ className, showLabels = true }: PageNavigationProps) => {
  ...
  const currentIndex = pages.findIndex(page => page.path === router.location.pathname)
