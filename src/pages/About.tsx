      ...
      <section className="px-40 flex flex-1 justify-center py-5">
        <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
              ...
              <div className="flex gap-4">
                <div className="flex flex-col gap-3 justify-center">
                  ...
                  <p className="text-[#111418] text-base font-normal leading-normal">
                    ...
                    tendances du web. Mon objectif est de fournir un travail de
                    qualité qui surprend les attentes de mes clients. Je donne
                    un soin particulier au référencement SEO de manière à
                    assurer une visibilité maximale ainsi qu’à l’impact
          ...
          <p className="text-[#111418] text-base font-normal leading-normal pb-3 pt-1 px-4">
            Étudiant en deuxième année de licence informatique à l’Université de
            La Rochelle, je suis passionné par les nouvelles technologies et
            l’innovation. J’aime relever des défis et mener mes projets avec
            rigueur et créativité. En parallèle, je me dépasse également sur la
            piste en compétition de demi-fond, où persévérance et performance
