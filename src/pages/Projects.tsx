...
import { Search, Code, Smartphone, Globe, Database, FolderOpen, Filter, Grid } from "lucide-react"
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(project =>
        ...
        project.technos.some(tech => tech.toLowerCase().includes(searchTerm.toLowerCase()))
      )
    }
      ...
      <div id="filters">
        <AnimatedSection className="py-12">
          <div className="container mx-auto px-6 lg:px-8">
            <div className="space-y-8">              {/* Barre de recherche */}
